...
var RealEstateProvider = (function () {
    ...
    RealEstateProvider.prototype.login = function (body) {
        return this.http.post('https://mentr.msts.com/api/users/auth', body, { headers: new __WEBPACK_IMPORTED_MODULE_0__angular_common_http__["b" /* HttpHeaders */]({ "Content-Type": "application/json" }) });
    };
    ...
    RealEstateProvider.prototype.register = function (body) {
        return this.http.post('https://mentr.msts.com/api/users/register', body, { headers: new __WEBPACK_IMPORTED_MODULE_0__angular_common_http__["b" /* HttpHeaders */]({ "Content-Type": "application/json" }) });
    };
...
var MyApp = (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["m" /* Component */])({template:/*ion-inline-start:"/Users/kevinmontanez/Desktop/rec/src/app/app.html"*/'<ion-nav [root]="rootPage"></ion-nav>\n'/*ion-inline-end:"/Users/kevinmontanez/Desktop/rec/src/app/app.html"*/
        }),
